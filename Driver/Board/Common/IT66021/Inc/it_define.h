...
#define IT_66021_I2C_COMPONENT_NUM  I2C_Component_2


#define RX_I2C_HDMI_MAP_ADDR            (0x90)
#define RX_I2C_EDID_MAP_ADDR            (0xA8)
#define RX_I2C_CEC_MAP_ADDR             (0xC8)
#define RX_I2C_RING_MAP_ADDR            (0xE0)
