...
File name: hal_softi2s_rightinterrupt.c
Description: audio right interrupt
NOTE: this file don't use -O1 to complie
Author: Artosy Software Team
Version: 0.0.1
Date: 2017/02/21
History:
         0.0.1    2017/02/21    The initial version of hal_softi2s_rightinterrupt.c
*****************************************************************************/
...
extern volatile uint32_t g_u32_audioRightInterruptAddr;
...
#endif /*PLL_CLK_200M_48K*/

#if PLL_CLK_200M_44p1K
void RightAudio(void) 
{      
    __asm volatile (      
    "ldr  r0, =g_u32_audioRightInterruptAddr\n"
...
#endif /*PLL_CLK_100M_48K*/

#if PLL_CLK_100M_44p1K
void RightAudio(void) 
{      
    __asm volatile (      
    "ldr  r0, =g_u32_audioRightInterruptAddr\n"
