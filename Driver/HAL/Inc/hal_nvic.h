...
typedef enum
{
    ...
    HAL_NVIC_CM7_1_FPU_IRQ_NUM0 = 91,                        //91
    ...
    HAL_NVIC_CM7_2_FPU_IRQ_NUM0 = 91,                        //91
    ...
    HAL_NVIC_CM7_3_FPU_IRQ_NUM0 = 91,                        //91
...
#define HAL_NVIC_PRIORITYGROUP_0         ((uint32_t)0x00000007) /*!< 0 bits for pre-emption priority
                                                                 5 bits for subpriority */
#define HAL_NVIC_PRIORITYGROUP_1         ((uint32_t)0x00000006) /*!< 1 bits for pre-emption priority
                                                                 4 bits for subpriority */
#define HAL_NVIC_PRIORITYGROUP_2         ((uint32_t)0x00000005) /*!< 2 bits for pre-emption priority
                                                                 3 bits for subpriority */
#define HAL_NVIC_PRIORITYGROUP_3         ((uint32_t)0x00000004) /*!< 3 bits for pre-emption priority
                                                                 2 bits for subpriority */
#define HAL_NVIC_PRIORITYGROUP_4         ((uint32_t)0x00000003) /*!< 4 bits for pre-emption priority
                                                                 1 bits for subpriority */
#define HAL_NVIC_PRIORITYGROUP_5         ((uint32_t)0x00000002) /*!< 5 bits for pre-emption priority
