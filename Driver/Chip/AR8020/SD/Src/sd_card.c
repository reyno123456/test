...
static SD_ErrorTypedef wait_cmd_busy(void);
static SD_ErrorTypedef wait_cmd_done(void);
static SD_ErrorTypedef convert_to_transfer(SD_HandleTypeDef *hsd);
