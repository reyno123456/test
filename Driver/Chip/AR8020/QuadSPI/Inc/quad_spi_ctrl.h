...
#define CMD3                    (3*4)          //write disable                 04h
#define CMD4                    (4*4)          //write SR1                     01h
#define CMD5                    (5*4)          //write SR2                     31h
#define CMD6                    (6*4)          //write SR3                     11h
#define CMD7                    (7*4)          
#define CMD8                    (8*4)          
#define CMD9                    (9*4)          //chip erase                    C7h
#define CMD10                   (10*4)
#define CMD11                   (11*4)
#define CMD12                   (12*4)
#define CMD13                   (13*4)
...
#define CMD17                   (17*4)          //write enable for volatile regs        50h
#define CMD18                   (18*4)
#define CMD19                   (19*4)
#define CMD20                   (20*4)          //sector erase(4KB)     20h
#define CMD21                   (21*4)          //block erase(64KB)     D8h
#define CMD22                   (22*4)
#define CMD23                   (23*4)
#define CMD24                   (24*4)
#define CMD25                   (25*4)
