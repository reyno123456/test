...
{
    {0x00, 0x01540736}, 
    //{0x04, 0x07800438}, picture size 
    {0x04, 0x050002D0}, 
    //{0x08, 0x011E4D28},   // GOP/FPS
    {0x08, 0x1E1E4D28},
    {0x0C, 0x00000000}, 
    {0x10, 0x00004000},		// DE mode: De exist, luma/chroma no swap
    //{0x14, 0x00030050},
    {0x14, 0x00030050}, 	// RC control enable, BU = 80
    //{0x18, 0x10300806}, 	// 
    {0x18, 0x28300806},		// QP = 40
    {0x1C, 0x00989680}, 
    {0x20, 0x04040000}, 
    {0x24, 0x00003907}, 
    //{0x28, 0x2B02589E},  	// Polarity detect mode
    {0x28, 0x1302889E},  	// BR Idx = 4, Polarity detect mode
    {0x2C, 0x12469422}, 
    {0x30, 0x00FFFF00}, 
    {0x34, 0x00002E00}, 
    {0x38, 0x18004600}, 
