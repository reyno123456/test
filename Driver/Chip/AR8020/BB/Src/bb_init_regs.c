...
// 2.4G
uint8_t RC_2_4G_frq[34][4] =
{
    {0x55, 0x55, 0x55, 0x50},   //2410
    {0x66, 0x66, 0x66, 0x50},   //2412
    {0x77, 0x77, 0x77, 0x50},   //2414
    {0x88, 0x88, 0x88, 0x50},   //2416
    {0x99, 0x99, 0x99, 0x50},   //2418
    {0xAA, 0xAA, 0xAA, 0x50},   //2420
    {0xBB, 0xBB, 0xBB, 0x50},   //2422
    {0xCC, 0xCC, 0xCC, 0x50},   //2424
    {0xDD, 0xDD, 0xDD, 0x50},   //2426
    {0xEE, 0xEE, 0xEE, 0x50},
    {0x00, 0x00, 0x00, 0x51},
    {0x11, 0x11, 0x11, 0x51},
    {0x22, 0x22, 0x22, 0x51},   //2434
    {0x33, 0x33, 0x33, 0x51},   //2436
    {0x44, 0x44, 0x44, 0x51},   //2438
    {0x55, 0x55, 0x55, 0x51},   //2440
    {0x66, 0x66, 0x66, 0x51},   //2442
    {0x77, 0x77, 0x77, 0x51},   //2444
    {0x88, 0x88, 0x88, 0x51},   //2446
    {0x99, 0x99, 0x99, 0x51},   //2448
    {0xAA, 0xAA, 0xAA, 0x51},   //2450
    {0xBB, 0xBB, 0xBB, 0x51},   //2452
    {0xCC, 0xCC, 0xCC, 0x51},   //2454
    {0xDD, 0xDD, 0xDD, 0x51},   //2456
    {0xEE, 0xEE, 0xEE, 0x51},   //2458
    {0x00, 0x00, 0x00, 0x52},   //2460
    {0x11, 0x11, 0x11, 0x52},   //2462
    {0x22, 0x22, 0x22, 0x52},   //2464
    {0x33, 0x33, 0x33, 0x52},   //2466
    {0x44, 0x44, 0x44, 0x52},   //2468
    {0x55, 0x55, 0x55, 0x52},   //2470
    {0x66, 0x66, 0x66, 0x52},   //2472
    {0x77, 0x77, 0x77, 0x52},   //2474
    {0x88, 0x88, 0x88, 0x52},   //2476
};


//2.4G
uint8_t IT_2_4G_frq[8][4] =
{
...
uint8_t IT_2_4G_20M_sweep_frq[4][4] =
{
...
// 5G RC frequncy
uint8_t RC_5G_frq[40][4] =
{
    {0x55, 0x55, 0xD5, 0x5F},   //5750
    {0xDD, 0xDD, 0xDD, 0x5F},   //5752
    {0x66, 0x66, 0xE6, 0x5F},   //5754
    {0xEE, 0xEE, 0xEE, 0x5F},   //5756
    {0x77, 0x77, 0xF7, 0x5F},   //5758
    {0x00, 0x00, 0x00, 0x60},   //5760
    {0x88, 0x88, 0x08, 0x60},   //5762
    {0x11, 0x11, 0x11, 0x60},   //5764
    {0x99, 0x99, 0x19, 0x60},   //5766
    {0x22, 0x22, 0x22, 0x60},   //5768
    {0xAA, 0xAA, 0x2A, 0x60},   //5770
    {0x33, 0x33, 0x33, 0x60},   //5772
    {0xBB, 0xBB, 0x3B, 0x60},   //5774
    {0x44, 0x44, 0x44, 0x60},   //5776
    {0xCC, 0xCC, 0x4C, 0x60},   //5778
    {0x55, 0x55, 0x55, 0x60},   //5780
    {0xDD, 0xDD, 0x5D, 0x60},   //5782
    {0x66, 0x66, 0x66, 0x60},   //5784
    {0xEE, 0xEE, 0x6E, 0x60},   //5786
    {0x77, 0x77, 0x77, 0x60},   //5788
    {0x00, 0x00, 0x80, 0x60},   //5790
    {0x88, 0x88, 0x88, 0x60},   //5792
    {0x11, 0x11, 0x91, 0x60},   //5794
    {0x99, 0x99, 0x99, 0x60},   //5796
    {0x22, 0x22, 0xA2, 0x60},   //5798
    {0xAA, 0xAA, 0xAA, 0x60},   //5800
    {0x33, 0x33, 0xB3, 0x60},   //5802
    {0xBB, 0xBB, 0xBB, 0x60},   //5804
    {0x44, 0x44, 0xC4, 0x60},   //5806
    {0xCC, 0xCC, 0xCC, 0x60},   //5808
    {0x55, 0x55, 0xD5, 0x60},   //5810
    {0xDD, 0xDD, 0xDD, 0x60},   //5812
    {0x66, 0x66, 0xE6, 0x60},   //5814
    {0xEE, 0xEE, 0xEE, 0x60},   //5816
    {0x77, 0x77, 0xF7, 0x60},   //5818
    {0x00, 0x00, 0x00, 0x61},   //5820
    {0x88, 0x88, 0x08, 0x61},   //5822
    {0x11, 0x11, 0x11, 0x61},   //5824
    {0x99, 0x99, 0x19, 0x61},   //5826
    {0x22, 0x22, 0x22, 0x61},   //5828
};


//5G
uint8_t IT_5G_frq[13][4] =
{
    {0x00, 0x00, 0x80, 0x5F},   //5730
    {0xAA, 0xAA, 0xAA, 0x5F},   //5740
    {0x55, 0x55, 0xD5, 0x5F},   //5750
    {0x00, 0x00, 0x00, 0x60},   //5760
    {0xAA, 0xAA, 0x2A, 0x60},   //5770
    {0x55, 0x55, 0x55, 0x60},   //5780
    ...
    {0x55, 0x55, 0xD5, 0x60},   //5810
    {0x00, 0x00, 0x00, 0x61},   //5820
    {0xAA, 0xAA, 0x2A, 0x61},   //5830
    {0x55, 0x55, 0x55, 0x61},   //5840
    {0x00, 0x00, 0x80, 0x61},   //5850
};

uint8_t IT_5G_20M_sweep_frq[7][4] =
{
    {0x55, 0x55, 0x95, 0x5F},   //5735
    {0xAA, 0xAA, 0xEA, 0x5F},   //5755
    {0x00, 0x00, 0x40, 0x60},   //5775
    {0x55, 0x55, 0x95, 0x60},   //5795
    {0xAA, 0xAA, 0xEA, 0x60},   //5815
    {0x00, 0x00, 0x40, 0x61},   //5835
    {0xAA, 0xAA, 0x6A, 0x61},   //5845
};
