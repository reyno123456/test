...
#define SYS_EVENT_ID_UART_DATA_SND_SESSION0           (SYS_EVENT_LEVEL_HIGH_MASK   | 0x0009)

#define SYS_EVENT_ID_UART_DATA_RCV_SESSION1           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000A | SYS_EVENT_INTER_CORE_MASK)
#define SYS_EVENT_ID_UART_DATA_RCV_SESSION2           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000B | SYS_EVENT_INTER_CORE_MASK)
#define SYS_EVENT_ID_UART_DATA_RCV_SESSION3           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000C | SYS_EVENT_INTER_CORE_MASK)

#define SYS_EVENT_ID_UART_DATA_SND_SESSION1           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000D)
#define SYS_EVENT_ID_UART_DATA_SND_SESSION2           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000E)
#define SYS_EVENT_ID_UART_DATA_SND_SESSION3           (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x000F)
