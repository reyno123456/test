...
#define SYS_EVENT_ID_ADV7611_FORMAT_CHANGE         (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x0001 | SYS_EVENT_INTER_CORE_MASK)
#define SYS_EVENT_ID_ADV7611_FORMAT_CHANGE_LOCAL   (SYS_EVENT_LEVEL_MIDIUM_MASK | 0x0001)
